...
js.event.Event.prototype = {
	...
	_init : function(domEvent) {
		...
		this.pageX = typeof domEvent.touches !== "undefined" ? domEvent.touches[0].pageX : domEvent.pageX;

		this.pageY = typeof domEvent.touches !== "undefined" ? domEvent.touches[0].pageY : domEvent.pageY;
