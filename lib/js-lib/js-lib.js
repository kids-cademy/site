...
js.ua.Window.prototype = {_DESTROY_CONFIRM: "Please confirm you want to leave the page.", open: function(url, parameters, features) {
  ...
  try {
    ...
    childWindow = new js.ua.Window(childNativeWindow, {parent: this, url: url, crossDomain: WinMain.url.isCrossDomain(url)});
  ...
  var anim = new js.fx.Anim({duration: 500, from: this._window.pageYOffset, to: child.style.getPageTop() - offset, ttf: js.fx.TTF.Logarithmic, render: function(top) {
...
js.dom.Control.prototype = {CSS_OPTIONAL: "optional", CSS_INVALID: "invalid", getName: function() {
  ...
  var value = this._getValue();
  if (!this.hasCssClass(this.CSS_OPTIONAL)) 
  {
    value = value.trim();
  }
...
js.dom.Button.prototype = {setValue: function(name) {
...
js.dom.Email.prototype = {EMAIL_REX: /^(([^<>()\[\]\.,;:\s@\"]+(\.[^<>()\[\]\.,;:\s@\"]+)*)|(\".+\"))@(([^<>()[\]\.,;:\s@\"]+\.)+[^<>()[\]\.,;:\s@\"]{2,})$/i, isValid: function() {
  var value = this._getValue();
  var valid = false;
  if (this.hasCssClass(this.CSS_OPTIONAL) && !value) 
  {
...
js.dom.FileInput.prototype = {setValue: function(value) {
  ...
  for (var i = 0; i < files.length; ++i) 
    {
      callback.call(scope || window, {name: this.getName(), value: files.item(i), extra: files.item(i).name});
    }
...
$package("js.dom");
js.dom.Node = {_BACK_REF: "__js_element__", _DATA_CLASS: "data-class", _DATA_FORMAT: "data-format", setElement: function(node, el) {
...
js.dom.Phone.prototype = {PHONE_REX: /^[\+]?[(]?[0-9]{3}[)]?[-\s\.]?[0-9]{3}[-\s\.]?[0-9]{3,6}$/im, isValid: function() {
  var value = this._getValue();
  var valid = false;
  if (this.hasCssClass(this.CSS_OPTIONAL) && !value) 
  {
...
js.dom.Select.prototype = {_DEF_OPTION_CSS: "default-option", load: function(remoteClassStub, remoteMethod) {
  ...
  return {value: option.value, text: option.text, data: this._dataMap[option.value]};
}, toString: function() {
  return "js.dom.Select";
}};
...
js.dom.Style.prototype = {set: function(style, value) {
  ...
  return {top: parseInt(this.getComputedStyle("border-top-width"), 10), right: parseInt(this.getComputedStyle("border-right-width"), 10), bottom: parseInt(this.getComputedStyle("border-bottom-width"), 10), left: parseInt(this.getComputedStyle("border-left-width"), 10)};
}, getPadding: function() {
  return {top: parseInt(this.getComputedStyle("padding-top"), 10), right: parseInt(this.getComputedStyle("padding-right"), 10), bottom: parseInt(this.getComputedStyle("padding-bottom"), 10), left: parseInt(this.getComputedStyle("padding-left"), 10)};
}, getMargin: function() {
  return {top: parseInt(this.getComputedStyle("margin-top"), 10), right: parseInt(this.getComputedStyle("margin-right"), 10), bottom: parseInt(this.getComputedStyle("margin-bottom"), 10), left: parseInt(this.getComputedStyle("margin-left"), 10)};
...
js.dom.template.OperatorsList.prototype = {initElement: function(element) {
  ...
  for (i = 0; i < attrs.length; i++) 
    {
      ...
      meta = {opcode: opcode, operand: attr.value};
  ...
  if (this._contentOperator === null) 
  {
    this._contentOperator = {opcode: js.dom.template.Opcode.OBJECT, operand: "."};
  }
  if (this._contentOperator !== null) 
  {
...
js.event.Event.prototype = {init: function(domEvent) {
  ...
  return this._domEvent.dataTransfer.getData(name);
}, toString: function() {
...
$package("js.event");
js.event.EventsMap = {handle: function(context, args) {
  if (args.length < 2) 
  {
    return false;
  }
...
$package("js.event");
js.event.Types = {abort: "HTMLEvents", beforeunload: "HTMLEvents", blur: "HTMLEvents", canplay: "MediaEvents", canplaythrough: "MediaEvents", change: "HTMLEvents", click: "MouseEvents", dblclick: "MouseEvents", drag: "DragEvent", dragend: "DragEvent", dragenter: "DragEvent", dragexit: "DragEvent", dragleave: "DragEvent", dragover: "DragEvent", dragstart: "DragEvent", drop: "DragEvent", durationchange: "MediaEvents", emptied: "MediaEvents", ended: "MediaEvents", error: "HTMLEvents", focus: "HTMLEvents", input: "HTMLEvents", keydown: "KeyboardEvent", keypress: "KeyboardEvent", keyup: "KeyboardEvent", load: "HTMLEvents", loadeddata: "MediaEvents", loadedmetadata: "MediaEvents", loadstart: "MediaEvents", mousedown: "MouseEvents", mousemove: "MouseEvents", mouseout: "MouseEvents", mouseover: "MouseEvents", mouseup: "MouseEvents", mousewheel: "SyntheticEvents", orientationchange: "HTMLEvents", paste: "UIEvents", pause: "MediaEvents", play: "MediaEvents", playing: "MediaEvents", progress: "MediaEvents", ratechange: "MediaEvents", reset: "HTMLEvents", resize: "HTMLEvents", scroll: "HTMLEvents", seeked: "MediaEvents", seeking: "MediaEvents", select: "HTMLEvents", stalled: "MediaEvents", submit: "HTMLEvents", suspend: "MediaEvents", timeupdate: "MediaEvents", touchcancel: "TouchEvent", touchend: "TouchEvent", touchmove: "TouchEvent", touchstart: "TouchEvent", transitionend: "TransitionEvent", unload: "HTMLEvents", volumechange: "MediaEvents", waiting: "MediaEvents"};
$package("js.format");
...
js.format.DateFormat.prototype = {_FORMAT_PATTERNS: /y{1,4}|M{1,4}|d{1,2}|E{1,4}|h{1,2}|H{1,2}|m{1,2}|s{1,2}|S{1,3}|a|z{1,4}|Z/g, _PATTERN_CHARS: "yMdEhHmsSazZ", format: function(date) {
  ...
  var index = 0;
  var rex = "";
  var match = {pattern: null, length: 0};
  function year() {
...
js.format.DateFormatSymbols._symbols = {patterns: {fullDate: "@string/full-date", fullTime: "@string/full-time", longDate: "@string/long-date", longTime: "@string/long-time", mediumDate: "@string/medium-date", mediumTime: "@string/medium-time", shortDate: "@string/short-date", shortTime: "@string/short-time"}, fullMonths: ["@string/full-jan", "@string/full-feb", "@string/full-mar", "@string/full-apr", "@string/full-may", "@string/full-jun", "@string/full-jul", "@string/full-aug", "@string/full-sep", "@string/full-oct", "@string/full-nov", "@string/full-dec"], shortMonths: ["@string/short-jan", "@string/short-feb", "@string/short-mar", "@string/short-apr", "@string/short-may", "@string/short-jun", "@string/short-jul", "@string/short-aug", "@string/short-sep", "@string/short-oct", "@string/short-nov", "@string/short-dec"], fullWeekDays: ["@string/full-su", "@string/full-mo", "@string/full-tu", "@string/full-we", "@string/full-th", "@string/full-fr", "@string/full-sa"], shortWeekDays: ["@string/short-su", "@string/short-mo", "@string/short-tu", "@string/short-we", "@string/short-th", "@string/short-fr", "@string/short-sa"], tinyWeekDays: ["@string/tiny-su", "@string/tiny-mo", "@string/tiny-tu", "@string/tiny-we", "@string/tiny-th", "@string/tiny-fr", "@string/tiny-sa"]};
$package("js.format");
...
$package('js.fx');
js.fx.Descriptor = {el: null, offset: null, duration: null, style: null, units: null, from: null, to: null, ttf: null, render: null};
$package("js.fx");
...
js.net.XHR.prototype = {on: function(type, listener, scope) {
  ...
  if (this._request.status === 500) 
  {
    ...
    {
      er = {url: this._url, cause: "Internal Server Error", message: parseHtmlBody(this._request.responseText)};
    } else {
  ...
  if (this._request.status === 400) 
  {
    ...
    {
      processError({url: this._url, cause: "Not Found", message: parseHtmlBody(this._request.responseText)});
    } else {
      throw new js.lang.Exception(this._url + "\nNot found.");
    }
    this._state = js.net.XHR.StateMachine.ERROR;
...
js.ua.Page.prototype = {requestFullScreen: function() {
