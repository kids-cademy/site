...
public class Instrument extends AtlasObject implements Serializable {
    ...
    @Embedded
    @AttributeOverrides({ @AttributeOverride(name = "value", column = @Column(name = "date_value")),
	...
	PERCUSSION,
	/**
	 * Produce sound from vibrating strings transmitted to the body of the
	 * instrument.
	 */
	STRINGS,
	/**
	 * Produce sound by directing a focused stream of air across the edge of a hole
